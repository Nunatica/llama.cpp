...
extern "C" {
    ...
    */
    ...
    // Generation of the dynamic MoE residency layout. Zero when the optional
    // two-tier cache is not registered.
    GGML_API uint64_t             ggml_backend_moe_cache_generation(void);
